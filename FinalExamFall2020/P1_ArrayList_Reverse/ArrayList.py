...
class ArrayList:
    ...
    def reverse_list(self):
        #Olog(n)
        forward_index = 0
        for backwards_index in range((self.size - 1), 0, -1):
            if forward_index == (self.size // 2):
                return
            forward_swap = self.arr[forward_index]
            backwards_swap = self.arr[backwards_index]
            self.arr[forward_index] = backwards_swap
            self.arr[backwards_index] = forward_swap
            forward_index += 1
